    ...
    <section className="w-full bg-background py-12 md:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          <h2 className="text-3xl font- font-cormorant tracking-tight text-foreground md:text-4xl lg:text-5xl">
            Premium Collection
          </h2>
...
function ProductGrid() {
  return (
    <div className="grid md:grid-cols-2">
      {/* Left - Fashion Look */}
      <div
        className={`relative aspect-[3/4] overflow-hidden rounded-lg bg-gradient-to-b md:h-[500px] lg:h-[600px] flex font-playfair items-center justify-center`}
      >
        <Image
      ...
      <div className={`flex flex-col justify-start space-y-6`}>
        ...
        <div className="flex flex-col gap-3 pt-4 sm:flex-row">
          <Link href={"/shop"}>
            <Button size="lg" className="cursor-pointer font-cormorant">
              Shop Collection
            </Button>
          </Link>
          {/* <Button
