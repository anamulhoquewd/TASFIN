...
export default function HomePage() {
  const categories = [
    { name: "2-Piece", image: "/elegant-2-piece-women-outfit.jpg", href: "/products?category=2-piece" },
    { name: "3-Piece", image: "/elegant-3-piece-women-outfit.jpg", href: "/products?category=3-piece" },
    { name: "Tops", image: "/elegant-women-tops.jpg", href: "/products?category=tops" },
    { name: "Salwar", image: "/elegant-salwar-kameez.jpg", href: "/products?category=salwar" },
    { name: "Night Dresses", image: "/elegant-night-dress.jpg", href: "/products?category=night-dresses" },
    { name: "T-Shirts", image: "/elegant-women-t-shirts.jpg", href: "/products?category=t-shirts" },
  ]
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative min-h-[600px] md:min-h-[700px] flex items-center justify-center bg-gradient-to-br from-secondary/20 to-accent/10">
        <div className="absolute inset-0 bg-[url('/elegant-women-fashion-model.jpg')] bg-cover bg-center opacity-20" />
      ...
      <section className="py-16 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-serif text-3xl md:text-4xl font-bold mb-4">New Arrivals Just Dropped!</h2>
          <p className="text-lg mb-6 opacity-90">Get 20% off on all new collection items this week</p>
          ...
          <Card className="border-border bg-gradient-to-br from-secondary/20 to-accent/10">
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty">
                Browse our complete collection and find the perfect outfit for every occasion
              </p>
