          ...
          <CardContent className="p-8 space-y-8">
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Welcome to TASFIN. By accessing and using our website, you
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                However, we do not warrant that product descriptions, colors, or
                other content available on the website are accurate, complete,
                reliable, current, or error-free. Colors may vary slightly due
                to screen settings and photography lighting.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Payment must be made in full before dispatch of goods. We accept
                various payment methods including Cash on Delivery, Bkash, and
                Bank Transfer.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                We accept returns and exchanges within 7 days of delivery for
                unused items in original condition with tags attached. Customers
                are responsible for return shipping costs unless the item is
                defective or incorrect. Refunds will be processed within 7-10
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                images, and software, is the property of TASFIN and is protected
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground leading-relaxed">
                TASFIN shall not be liable for any indirect, incidental,
                special, or consequential damages arising out of or in
                connection with the use of our website or products. Our total
